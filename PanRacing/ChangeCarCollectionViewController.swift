...
class ChangeCarCollectionViewController: UICollectionViewController {
    ...
    let cars = ["ic_sedan_purple", "ic_sedan_pink", "ic_sedan_blue", "ic_sport_car"]
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, shouldSelectItemAt indexPath: IndexPath) -> Bool {
        ...
        let alert = UIAlertController(title: "Car change", message: "Car was changed", preferredStyle: .alert)
